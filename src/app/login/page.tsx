...
export default function LoginPage() {
  ...
  useEffect(() => {
    fetch("/api/auth/status")
      .then(res => res.json())
      .then(data => {
        setGoogleEnabled(data.configured);
    ...
    <div className="min-h-screen bg-black flex">
      <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-12">
        <div className="w-full max-w-md">
          ...
          {checkingGoogle ? (
            <div className="w-full py-3.5 px-4 bg-gray-900/50 border border-gray-700 rounded-xl text-gray-400 flex items-center justify-center gap-2">
            ...
            <div className="w-full py-3.5 px-4 bg-gray-800/50 border border-gray-700 rounded-xl text-gray-500 text-center">
          ...
          <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
            ...
            <p className="text-gray-400 text-xs">Demo User: demo@izipay.com / Demo@12345</p>
            <p className="text-gray-400 text-xs">Demo Admin: admin@izipay.com / Admin@12345</p>
          </div>
        </div>
      </div>
