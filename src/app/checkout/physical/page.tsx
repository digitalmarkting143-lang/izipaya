...
export default function CheckoutPhysicalPage() {
  ...
  const trackingNumber = "IZP-" + Math.random().toString(36).substring(2, 10).toUpperCase() + "-METAL";
  ...
  const handlePaymentComplete = () => {
    ...
    setTimeout(() => {
      const fullNumber = "5425" + Math.floor(10000000 + Math.random() * 90000000).toString();
      const card = {
      ...
      addCard("physical", cardholderName.trim() || "IZIPAY USER");
      addTransaction("Physical Metal Card Purchase", amount, "Physical Metal Card");
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-2xl border border-gray-200 shadow-sm p-8 text-center">
          ...
          <p className="text-gray-500 mb-6">Your physical metal card is being prepared.</p>
          
          <div className="bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 rounded-xl p-4 mb-6 text-white border border-gray-600">
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6">
            ...
            <p className="text-lg font-mono font-semibold text-gray-900">{trackingNumber}</p>
          </div>

          <div className="bg-[#88D65E]/10 rounded-xl p-4 mb-6">
            <p className="text-sm text-[#88D65E] font-medium">Estimated Delivery: 5-7 business days</p>
          </div>

          <div className="space-y-3">
            <Link href="/dashboard" className="block w-full py-3 bg-gray-900 text-white font-semibold rounded-xl hover:bg-gray-800 transition-colors">
              Go to Dashboard
            </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 lg:p-8 mb-6">
              ...
              <div className="border-t border-gray-100 pt-6">
                ...
                <ul className="space-y-3">
                  {["Stainless steel metal design", "Premium card holder", "Contactless payments", "Priority support", "2-year warranty"].map((item, i) => (
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 lg:p-8">
              ...
              <div className="mb-4">
                ...
                />
                <p className="text-xs text-gray-500 mt-2">Will appear on your metal card. Max 24 characters.</p>
              </div>
          ...
          <div>
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 lg:p-8 sticky top-24">
              ...
              <button onClick={handlePaymentComplete} disabled={isProcessing} className="w-full py-4 bg-gray-900 text-white font-semibold rounded-xl hover:bg-gray-800 transition-colors disabled:opacity-70 flex items-center justify-center gap-2">
                {isProcessing ? (<><div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div>Processing...</>) : "I have completed payment"}
              </button>

              <p className="text-xs text-gray-500 text-center mt-4">Your card will be shipped within 24 hours</p>
            </div>
          </div>
        </div>
      </div>
