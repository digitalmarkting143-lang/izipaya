...
export default function CheckoutVirtualPage() {
  ...
  const demoQrData = "izipay://pay/demo-virtual-card-49.99";
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-white rounded-2xl border border-gray-200 shadow-sm p-8 text-center">
          ...
          <p className="text-gray-500 mb-6">Your virtual card has been created and is ready to use.</p>
          
          <div className="bg-gray-50 rounded-xl p-4 mb-6">
            <p className="text-sm text-gray-500 mb-1">Card Number</p>
            <p className="text-lg font-mono font-semibold text-gray-900">•••• •••• •••• 8831</p>
          </div>
          ...
          <div>
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 lg:p-8 sticky top-24">
              ...
              <button
                ...
                className="w-full py-4 bg-[#88D65E] text-black font-semibold rounded-xl hover:bg-[#76C14D] transition-colors disabled:opacity-70 flex items-center justify-center gap-2"
              >
                {isProcessing ? (
                  <>
